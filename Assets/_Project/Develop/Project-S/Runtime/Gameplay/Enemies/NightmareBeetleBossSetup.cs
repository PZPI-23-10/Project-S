...
namespace Project_S.Runtime.Gameplay.Enemies
{
    ...
    public class NightmareBeetleBossSetup : MonoBehaviour
    {
        ...
        [SerializeField] private Vector3 _healthBarOffset = new Vector3(0f, 2.8f, 0f);
        ...
        private void Apply()
        {
            ...
            SyncAttackProfileReachWithConfig();
        ...
        private void SyncAttackProfileReachWithConfig()
        {
            if (_attackProfiles == null || _config == null)
                return;

            float attackRange = Mathf.Max(0f, _config.AttackRange);
            float attackRadius = Mathf.Max(0f, _config.AttackRadius);
