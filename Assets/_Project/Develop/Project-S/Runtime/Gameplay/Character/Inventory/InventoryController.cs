...
namespace Project_S.Runtime.Gameplay.Character.Inventory
{
    ...
    public class InventoryController : MonoBehaviour
    {
        ...
        public float GetWeightSpeedMultiplier()
        {
            ...
            if (ratio >= 1.2f) return 0.4f; // <120% - мінус 60% швидкості (залишається 40%)
            if (ratio >= 1.0f) return 0.95f; // <100% (тобто рівно або трохи більше 100%) - мінус 5%

            return 1f; // Якщо вага в нормі
        }
